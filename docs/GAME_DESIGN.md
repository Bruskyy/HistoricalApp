...
- **Antecipação é mecânica de produto ("a biblioteca infinita").** Cada estante mostra, sob as jornadas abertas, a lista **"em breve"**: jornadas nomeadas, com ícone, ainda em escrita (⚔️ Guerras Médicas, 🦅 Roma, 🧘 Estoicismo…). A Biblioteca de Filosofia inteira é navegável como promessa — estantes e jornadas visíveis, todas seladas. O objetivo emocional: ao abrir a Biblioteca, sentir que **há um mundo enorme esperando** — "olha tudo que ainda vou desbloquear" — como Zelda mostra a montanha antes de deixar você escalar. Regra de honestidade (EDITORIAL_POLICY): os números nunca somam promessa com realidade — "aberto" e "em escrita" são sempre contados separados, e tudo que aparece como "em breve" precisa estar de fato no plano editorial.
